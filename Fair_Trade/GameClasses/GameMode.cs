...
namespace Fair_Trade.GameClasses
{
    public static class GameMode
    {
        ...
        public static Dictionary<List<string>, Type> GetSettingsDictionary()
        {
            ...
            //settingsNameValueType.Add(new List<string> { "Game Mode", _gameMode.ToString() }, _gameMode.GetType());
        ...
        //public static void SetGameMode(string mode) => _gameMode = mode;
        //public static string GetGameMode() => _gameMode; 
