...
namespace Fair_Trade.GameClasses.GameBase
{
    internal class Player
    {
        ...
        public Player(Type playerType, CardGame parentScene, CardGame.PlayerClass newPlayerClass=null)
        {
            type = playerType;
            ...
            List<Card> _cardsOnBoard = new List<Card>();
            List<Card> _cardsInDump = new List<Card>();
