...
namespace Fair_Trade.GameClasses.GameBase.BasicCardMechanics
{
    internal class UnitCard : Card
    {
        ...
        public UnitCard(Vector2 size, Vector2 topLeftPoint, Player owner, int price = 0, bool canBePlayed = true,
            Image faceSprite = null, bool isOnBoard= false, StatusEffect statusEffect=null): base(topLeftPoint, size, price, owner, canBePlayed, faceSprite)
        {
